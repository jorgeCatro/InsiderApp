...
class RiskEvaluatorApp:
    ...
    def create_gui(self):
        ...
        self.create_dropdown("Extroversión junto con Psicopatía", "psychological", 5, 0)
        self.create_dropdown("Extroversión junto con Narcisismo", "psychological", 7, 0)
    ...
    def evaluate_risk(self, ignore_incomplete=False):
        ...
        self.evaluator.evaluate_psychological(
            ...
            ext_psych=self.psychological_extroversión_junto_con_psicopatía.get(),
            ext_narc=self.psychological_extroversión_junto_con_narcisismo.get(),
